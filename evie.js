...
function addEntry(icon_value) {
    ...
    if(icon_value=="bottle") {
        db.collection('evie_log').insertOne({'time': time_value, 'icon': icon_value, 'volume': volume_value, 'comment': comment_value, 'timestamp': timestamp_value, 'blog_date': date_value });
    } else {
        db.collection('evie_log').insertOne({'time': time_value, 'icon': icon_value, 'comment': comment_value, 'timestamp': timestamp_value, 'blog_date': date_value });
    }
